...
##### 6.1.10.5 [Move service across regions]()
...
### 6.3 [Vector search]()
#### 6.3.1 [Create a vector index]()
#### 6.3.2 [Chunk documents]()
#### 6.3.3 [Chunk and vectorize by document layout]()
#### 6.3.4 [Generate embeddings]()
#### 6.3.5 [Use embeddings models from Azure AI Foundry]()
#### 6.3.6 Reduce vector size
##### 6.3.6.1 [Understand vector quotas and limits]()
##### 6.3.6.2 [Choose an optimization strategy]()
##### 6.3.6.3 [Compress using binary or scalar quantization]()
##### 6.3.6.4 [Index binary data for vector search]()
##### 6.3.6.5 [Assign narrow data types]()
##### 6.3.6.6 [Eliminate redundant storage]()
##### 6.3.6.7 [Truncate dimensions]()
#### 6.3.7 [Query vectors]()
#### 6.3.8 [Add a vectorizer for text-to-vector queries]()
#### 6.3.9 [Filter on vector queries]()

### 6.4 [Keyword search]()
#### 6.4.1 [Full text search]()
#### 6.4.2 [Typeahead query]()
#### 6.4.3 [Query examples (simple syntax)]()
#### 6.4.4 [Add spell check]()
#### 6.4.5 [Add synonyms]()
#### 6.4.6 [Add a suggester for typeahead]()
#### 6.4.7 [Design a multilingual index]()
#### 6.4.8 [Model complex data types]()
#### 6.4.9 [Model relational data]()
#### 6.4.10 Analyzers
##### 6.4.10.1 [Analyzers overview]()
##### 6.4.10.2 [Add a language analyzer]()
##### 6.4.10.3 [Add a custom analyzer]()
#### 6.4.11 Filters
##### 6.4.11.1 [Filters in text queries]()
##### 6.4.11.2 [Add faceted navigation]()
##### 6.4.11.3 [Understand collection filters]()
##### 6.4.11.4 [Troubleshoot collection filters]()
##### 6.4.11.5 [Normalize text filters]()
#### 6.4.12 Search results
##### 6.4.12.1 [Page, sort and shape results]()
##### 6.4.12.2 [Return a semantic answer]()
#### 6.4.13 Advanced queries
##### 6.4.13.1 [Use full Lucene (examples)]()
##### 6.4.13.2 [Partial terms and special characters]()
##### 6.4.13.3 [Fuzzy search]()

### 6.5 [Hybrid search]()
### 6.6 [Ranking and Relevance]()
#### 6.6.1 [Add a scoring profile]()
#### 6.6.2 [Configure BM25 ranking]()
#### 6.6.3 [Enable or disable semantic ranker]()
#### 6.6.4 [Configure semantic ranker]()
#### 6.6.5 [Add semantic ranking to queries]()
#### 6.6.6 [Rewrite queries with semantic ranker]()
#### 6.6.7 [Migrate semantic ranking code]()

### 6.7 [Security]()
#### 6.7.1 [Configure network access]()
#### 6.7.2 [Enable role-based access]()
#### 6.7.3 [Assign roles (users)]()
#### 6.7.4 [Assign roles (apps)]()
#### 6.7.6 [Authenticate with keys]()
#### 6.7.7 Outbound connections
##### 6.7.7.1 [Configure a managed identity]()
##### 6.7.7.2 Connect using a managed identity
###### 6.7.7.2.1 [Azure Storage]()
###### 6.7.7.2.2 [Azure Cosmos DB]()
###### 6.7.7.2.3 [SQL Database]()
###### 6.7.7.2.4 [SQL Managed Instance]()
###### 6.7.7.2.5 [Connect to an Azure Function]()
##### 6.7.7.3 [Connect through a firewall]()
##### 6.7.7.4 [Connect using Network Security Perimeter]()
##### 6.7.7.5 [Connect as a trusted service]()
##### 6.7.7.6 [Connect through a shared private link]()
##### 6.7.7.7 [Connect to a SQL managed instance private endpoint]()

#### 6.7.8 [Document-level security]()

#### 6.7.9 Advanced options
##### 6.7.9.1 [Create a private endpoint]()
##### 6.7.9.2 [Troubleshoot private connections]()
##### 6.7.9.3 Data encryption
###### 6.7.9.3.1 [Customer-managed keys]()
###### 6.7.9.3.2 [Find encrypted objects]()

### 6.8 [Development]()
#### 6.8.1 [API versions]()
#### 6.8.2 [Preview features]()
#### 6.8.3 [Upgrade the REST API]()
#### 6.8.4 [Upgrade .NET Libraries]()
#### 6.8.5 [Develop in .NET]()
#### 6.8.6 [Manage with Azure SDKs]()
#### 6.8.7 [Handle concurrent updates]()
...
##### 8.4.4.3 [$select]()
##### 8.4.4.4 [any, all]()
##### 8.4.4.5 [eq, ne, gt, ge, lt, le]()
##### 8.4.4.6 [search.ismatch, search.ismatchscoring]()
##### 8.4.4.7 [geo.distance, geo.intersects]()
##### 8.4.4.8 [and, or, not]()
##### 8.4.4.9 [search.in]()
##### 8.4.4.10 [search.score]()
##### 8.4.4.11 [OData Language Grammar]()
